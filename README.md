...
| Event Type | Hugo Builder <small>(Re-Builds Site Cache-Free)</small> | Hugo Updater <small>(Rebuilds site with newest Hugoversion)</small> | PR Merger <small>(Accepts all Dependabot PRs)</small> |
|------------|:----------------------------------:|:-----------------------------------:|:------------------------------:|
